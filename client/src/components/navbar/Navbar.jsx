...
import PGconnect from "../../assets/PGconnect.jpg";
...
const Navbar = () => {
  ...
  useEffect(() => {
    setState((prev) => {
      return { ...prev, continent: "Navjeevan Society", type: "1BHK" };
    });
  }, []);
    ...
    <div className={`${classes.container} ${isScrolled && classes.scrolled}`}>
      <div className={classes.wrapper}>
        <Link to="/" onClick={scrollToTop} className={classes.left}>
          <img src={PGconnect} alt="" width="50px" />
        </Link>
            ...
            >
              ...
              <form onSubmit={handleListProperty}>
                ...
                >
                  ...
                  <option value="Navjeevan Society">Navjeevan Society</option>
                  <option value="Sindhi Society">Sindhi Society</option>
                  <option value="Nityanand Society">Nityanand Society</option>
                  <option value="Gurumukh Sadan Society">
                    Gurumukh Sadan Society
                  </option>
                  <option value="Tolaram Colony">Tolaram Colony</option>
                  <option value="Collector Colony">Collector Colony</option>
                </select>
                <input
                  value={state?.price}
                  type="number"
